...
class MainFrame(SpecFrame):
    ...
    def alignAll(self):
        ...
        #Column 1
        self.name_label.grid(column=1, row=2, sticky=("we"))
        self.name_entry.grid(column=1, row=3, sticky=("we"))
        self.data_entry.grid(column=1, row=4, sticky=("we"))
        
        #Column 2
        self.event_label.grid(column=2, row=2, sticky=("we"))
        self.event_entry.grid(column=2, row=3, sticky=("we"))
        self.qr_label.grid(column=2, row=4, sticky=("we"))
        
        #Column 3
        self.encrypt.grid(column=3, row=3, sticky=("we"))
